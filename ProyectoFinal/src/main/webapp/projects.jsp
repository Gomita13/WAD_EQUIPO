...
<head>
    ...
    <style>
        :root {
            ...
            --clr-light-lime: linear-gradient(90deg, rgba(135,0,163,1) 15%, rgba(255,150,0,1) 100%);
        }
    </style>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="ab-progress" data-progress data-value="70" data-fill="var(--clr-light-lime)" data-height="35"></div>
                    </div>
                </div>
            </div>
        </div>
